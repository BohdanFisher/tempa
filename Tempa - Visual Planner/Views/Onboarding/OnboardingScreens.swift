...
struct OnbWelcomeView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Welcome to Tempa")
                .font(.custom("Nunito-ExtraBold", size: 34).weight(.heavy))
                .tracking(-0.7)
            ...
            Text("The calm planner that turns big tasks into small, doable steps.")
                .font(.custom("Inter-Medium", size: 15.5).weight(.medium))
